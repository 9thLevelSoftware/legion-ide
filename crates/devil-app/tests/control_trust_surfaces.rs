...
fn ai_outcome(outcome: AppCommandOutcome) -> devil_app::AppAiRunOutcome {
    match outcome {
...
fn opened_text_file(
    ...
    devil_protocol::WorkspaceOpened,
    FileId,
    BufferId,
    FileTreeNode,
    ProposalVersionPreconditions,
...
fn assisted_ai_refusals_visible_for_untrusted_workspace() {
    ...
    assert_eq!(
        outcome.route_response.invocation_state,
        devil_protocol::AssistedAiProviderInvocationState::Refused
    );
