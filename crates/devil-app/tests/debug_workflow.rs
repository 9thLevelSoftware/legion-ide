...
use devil_protocol::{DebugSessionId, DebugSessionState, PrincipalId, WorkspaceTrustState};
use devil_ui::{CommandDispatchIntent, DebugStatusKindProjection, DebugStepKindProjection};
...
fn debug_workflow_persists_breakpoints_launches_fixture_and_projects_docks() {
    ...
    for intent in [
        ...
        CommandDispatchIntent::DebugRunToCursor {
            session_id: session_id.clone(),
            buffer_id,
            position: devil_protocol::TextCoordinate {
                line: 2,
                character: 4,
                byte_offset: None,
                utf16_offset: None,
