...
pub mod tools;
/// Sandbox orchestration and containment validation.
pub mod worktree;
...
use legion_protocol::{
    AssistedAiEditProposalOutput, AssistedAiOperationClass, AssistedAiProposalTargetIntent,
    AssistedAiProviderClass, AssistedAiProviderRouteRequest, AssistedAiTrustProjectionReference,
    CancellationTokenId, CanonicalPath, CapabilityId, EventSequence, FileFingerprint,
    LegionEvidenceKind, LegionEvidencePrivacyScope, LegionEvidenceRecord, LegionEvidenceSource,
    LegionModelCapability, LegionProviderLocalityPreference, LegionProviderPrivacyPolicy,
    LegionProviderRouteHealth, LegionProviderRouteMetadata, LegionTaskFileScope,
    LegionTaskOutputContract, LegionTaskPacket, LegionTaskPacketId, LegionTaskPolicy,
    LegionTaskValidationPlan, LegionWorkerResult, LegionWorkerResultKind, LegionWorkflowConflict,
    ...
    LegionWorkflowWorkerState, PrincipalId, ProposalAffectedTarget, ProposalPayloadKind,
    ...
    validate_legion_task_packet, validate_legion_worker_result, validate_legion_workflow_session,
};
...
fn derive_cancellation_token(worker_id: &str, correlation_id: u64) -> CancellationTokenId {
    CancellationTokenId(uuid::Uuid::from_u128(crate::worktree::stable_hash_128(
...
fn derive_event_sequence(worker_id: &str, correlation_id: u64) -> EventSequence {
    EventSequence(crate::worktree::stable_hash_128(
...
mod tests {
    ...
    use legion_protocol::{
        ...
        AssistedAiTrustProjectionKind, CausalityId, CommandRiskLabel, ContextManifestItemCount,
        CorrelationId, DelegatedTaskAffectedTargetSummary, DelegatedTaskOperationClass,
        DelegatedTaskPlanId, DelegatedTaskToolPermissionProfile, EventSequence, FileFingerprint,
        ...
        PermissionBudgetActionClass, PrivacyClassification, ProposalId, ProposalPayload,
        ProposalPrivacyLabel, ProposalRiskLabel, ProposalTargetKind, RedactionHint,
        TimestampMillis, WorkspaceId, validate_legion_workflow_session,
    };
