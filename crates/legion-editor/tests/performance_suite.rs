...
use legion_text::{DEFAULT_FULL_CACHE_BYTE_BUDGET_BYTES, TextEdit, TextRange};
    ...
    for idx in 0..SAMPLES {
        ...
        collaboration
            .apply_protocol_edits(EditorApplyTransactionRequest {
                ...
                undo_group_id: None,
                correlation_id: legion_protocol::CorrelationId(idx as u64 + 1),
            })
...
fn ci_collaboration_snapshot_consumer_overhead_p95_p99() {
    ...
    for idx in 0..SAMPLES {
        let descriptor = TextTransactionDescriptor {
            ...
            pre_snapshot_id: legion_protocol::SnapshotId(idx as u128 + 1),
            post_snapshot_id: legion_protocol::SnapshotId(idx as u128 + 2),
            pre_buffer_version: legion_protocol::BufferVersion(idx as u64 + 1),
            post_buffer_version: legion_protocol::BufferVersion(idx as u64 + 2),
