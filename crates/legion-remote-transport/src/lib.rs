...
impl RemoteTransportFixture {
    ...
    pub fn accept_frame(
        ...
        let summary = RemoteTransportAuditSummary {
            ...
            correlation_id: legion_protocol::CorrelationId(frame.frame_sequence.0),
            causality_id: legion_protocol::CausalityId(uuid_from_sequence(frame.frame_sequence.0)),
            metadata_summary: format!(
...
mod tests {
    ...
    fn handshake() -> RemoteTransportHandshake {
        RemoteTransportHandshake {
            ...
            causality_id: legion_protocol::CausalityId(uuid_from_sequence(5)),
    ...
    fn rustls_mtls_carrier_builds_optional_mtls_config_without_inline_material() {
        ...
        assert_eq!(
            ...
            vec![b"legion-remote/phase8".to_vec()]
        );
    }
