...
| `src/tools/tool_call_extractor.js`, `src/tools/liquid_tool_parser.js`, `src/tools/tool_aliases.js` | `legion-ai` tool-call normalizer | nothing yet (semantics port planned) | planned |
