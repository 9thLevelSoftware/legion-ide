...
gate 12 'Clippy gate' cargo clippy --workspace --all-targets -- -D warnings
gate 13 'Supply-chain policy gate' cargo deny check
gate 14 'Rust analyzer smoke gate' cargo run -p xtask -- rust-analyzer-smoke
gate 15 'Golden Path 1 gate' cargo run -p xtask -- golden-path-1
gate 16 'Golden Path 2 gate' cargo run -p xtask -- golden-path-2
gate 17 'Golden Path 3 gate' cargo run -p xtask -- golden-path-3
gate 18 'Golden Path 4 gate' cargo run -p xtask -- golden-path-4
gate 19 'Performance harness gate' cargo run -p xtask -- perf-harness
gate 20 'Performance harness verification gate' cargo run -p xtask -- verify-perf-harness
gate 21 'Update drill gate' cargo run -p xtask -- update-drill
