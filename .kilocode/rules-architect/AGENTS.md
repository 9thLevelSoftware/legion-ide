...
- `legion-protocol` is the boundary crate for cross-domain IDs/DTOs/ports; changing boundary symbols requires updating `plans/dependency-policy.md` because `xtask` validates their presence literally.
