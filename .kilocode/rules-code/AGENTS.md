...
- Do not make `legion-editor` depend on `legion-project`; cross-domain DTOs/ports belong in `legion-protocol`, and `xtask` has hardcoded enforcement beyond the markdown policy.
